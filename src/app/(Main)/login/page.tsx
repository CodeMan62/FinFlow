...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br bg-black dark:from-gray-900 dark:to-gray-800 p-4">
      ...
      <Card className="w-full max-w-md relative border-2  border-orange-100 dark:border-gray-700 backdrop-blur-sm bg-white dark:bg-gray-900/80">
        ...
        <CardContent className="space-y-4">
          <Button
            className="w-full bg-white hover:bg-gray-50 text-gray-800 border-2 border-orange-100 hover:border-orange-200 dark:bg-gray-800 dark:text-white dark:border-orange-900 dark:hover:bg-gray-700 transition-all duration-200 group relative"
